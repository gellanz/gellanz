...
I am a Software Engineer focused on Python who enjoys building and making things better.

On December 2024 I joined BlackRock <img src="https://yt3.googleusercontent.com/KVb5Psa5k0m7vpSVGyoNj0_rb_e8L0sQ93uKZbjbv6o6V3IsHFmDfC8x_WBkIzuPp0EyTgOoV7k=s900-c-k-c0x00ffffff-no-rj" alt="br" width="12" height="12"/> as a Software Engineer, my first project was to integrate Pantsbuild to our monorepo, leading to build from scratch 2 pipelines, one for quality and the other for publishing wheels. Also, the developer experience has improved a lot since then!

On September 2023 I joined Thermo Fisher Scientific <img src="https://upload.wikimedia.org/wikipedia/en/thumb/5/5d/Thermo_Fisher_Scientific_Logo.svg/1200px-Thermo_Fisher_Scientific_Logo.svg.png" alt="nu" width="17" height="12"/> as a Data Engineer, I had the opportunity to learn and build a lot here, from Data Engineering best practices to Web Development, I had the full picture of a web app that fetched data that was populated from data pipelines.

On february 2023 I joined Elementary Robotics as a Machine Learning Aplication Engineer, I did some automation on report generation.
...
On Spring 2022 I got the opportunity to be be an Open Source fellow in the MLH fellowship <img src="https://user-images.githubusercontent.com/60515606/163269362-9ed3fa1f-315c-49ce-834a-f24a25c19b5f.png" alt="mlh" width="12" height="12"/>.
...
<img src="https://www.pantsbuild.org/img/logo.svg" alt="python" width="40" height="40"/>
...
<img src="https://github.com/devicons/devicon/blob/master/icons/fastapi/fastapi-original.svg" alt="go" width="40" height="40"/>
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/React.svg/1200px-React.svg.png" alt="go" width="40" height="40"/>
...
<img src="https://raw.githubusercontent.com/devicons/devicon/ca28c779441053191ff11710fe24a9e6c23690d6/icons/postgresql/postgresql-original.svg" alt="go" width="40" height="40"/>
...
<img src="https://raw.githubusercontent.com/devicons/devicon/ca28c779441053191ff11710fe24a9e6c23690d6/icons/azuredevops/azuredevops-original.svg" alt="go" width="40" height="40"/>
